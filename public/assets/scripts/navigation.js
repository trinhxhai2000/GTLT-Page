        ...
        if (document.getElementById("navigationmenu") != null) {
            ...
            button.onclick = function (e) {
                ...
                if (-1 != this.className.indexOf("toggled-on")) {
                    ...
                    items.className = items.className.replace(
                        " toggled-on",
                        ""
                    );
                } else {
                        ...
                        if (childNode.length > 0) {
                            liChild[k].onclick = function (e) {
                                ...
                                if (z == 500) {
                                    if (
                                        -1 ==
                                        this.className.indexOf(" toggled-on")
                                    ) {
                                        var toggleClass = $(
                                            this.parentNode
                                        ).find(".toggled-on");
            ...
            for (var i = 0; i < child.length; i++) {
                ...
                parent.onclick = function (e) {
                    ...
                    if (y != "none") {
                        ...
                        if (
                            -1 != childname[0].className.indexOf("vtoggled-on")
                        ) {
                            childname[0].className =
                                childname[0].className.replace(
                                    " vtoggled-on",
                                    ""
                                );
                        } else {
