$(document).ready(function () {
  ...
  if (body_height < window_height) {
    ...
    $("#ttr_content_and_sidebar_container").css(
      "min-height",
      content_height + "px"
    );
  }
  ...
  $("ul.ttr_vmenu_items.nav li [data-toggle=dropdown]").on(
    "click",
    function () {
      var window_width = Math.max(
        document.documentElement.clientWidth,
  ...
  $(".ttr_menu_items ul.dropdown-menu [data-toggle=dropdown]").on(
    "click",
    function (event) {
      var window_width = Math.max(
        document.documentElement.clientWidth,
  ...
  if (window_width < 1025) {
    ...
    $(".ttr_page_align_right").each(function () {
      ...
      $(this).css({
        right: "-" + page_align_left_value + "px",
  ...
  $(".ttr_vmenu_items ul.dropdown-menu [data-toggle=dropdown]").on(
    "click",
    function (event) {
      var window_width = Math.max(
        document.documentElement.clientWidth,
